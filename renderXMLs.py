...
def renderXMLs(refXMLPath:str, outputDp:str):
    ...
    outputDp: str
        Directory path to dump the rendered audio (The name of the rendered audio will be same as that of the XML)
    ...
    Note
    ----
    Incase the output directory contains the rendered audio of an XML, we do not re-render it.
    """
...
if __name__ == "__main__":
    ...
    renderXMLs(args.xmlpath, args.outputpath)